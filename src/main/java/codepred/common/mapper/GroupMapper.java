...
import codepred.calendar.get.GroupEventDto;
import codepred.group.Group;
import codepred.group.dto.CreateGroupRequest;
import codepred.group.dto.UpdateGroupRequest;
...
public interface GroupMapper {
    GroupEventDto toDtoGetToEvent(Group group);

    Group fromCreateGroupDTO(CreateGroupRequest createGroupRequest);


    Group fromUpdateGroupDTO(UpdateGroupRequest updateGroupRequest);
